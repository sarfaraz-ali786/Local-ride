    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        /* SPEED LINES */
        .speed-lines {
          position:absolute; bottom:calc(38% + 20px); left:0; right:50%;
        ...
        .card-title {
          ...
          font-weight:800; color:var(--purple); margin-bottom:4px;
        }
        ...
        .divider::before, .divider::after {
          ...
          width:38%; height:1px; background:#ede8f8;
        }
        ...
        .btn-register {
          ...
          border:2px solid var(--purple3); border-radius:14px;
      ...
      <div className="scene">
        ...
        <div className="car-wrap">
          ...
          <svg className="car-svg" viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="172" y="50" width="12" height="8" rx="3" fill="url(#headlightGlow)" opacity="0.8"/>
            {/* Tail Light */}
